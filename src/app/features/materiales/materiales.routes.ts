...
export const MATERIALS_ROUTES: Routes = [
  ...
  { path: 'materiales/asignaciones', canActivate: [roleGuard], data: { roles: ['administrador', 'administrador_erp'] }, loadComponent: () => import('./administration/asignaciones.component').then((m) => m.MaterialesAsignacionesComponent) },
