...
/**
 * Notificaciones propias de Materiales para aprendiz — copia casi literal de
 * `features/admin/materiales/notificaciones.component.ts` (ver + marcar
 * leída, sin gating adicional: cada usuario ve solo las suyas por diseño
 * del backend, filtradas por `id_usuario`).
 */
@Component({
  selector: 'app-aprendiz-materiales-notificaciones',
  standalone: true,
  imports: [DatePipe],
  template: `
    <div class="p-6">
...
export class AprendizMaterialesNotificacionesComponent implements OnInit {
