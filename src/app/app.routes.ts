    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'materiales/existencias', canActivate: [roleGuard], data: { roles: ['administrador', 'administrador_erp'] }, loadComponent: () => import('./features/admin/materiales/existencias.component').then((m) => m.MaterialesExistenciasComponent) },
          ...
          { path: 'instructor/materiales/existencias', canActivate: [roleGuard], data: { roles: ['instructor'], serviciosRequeridos: ['materiales.existencias.ver'] }, loadComponent: () => import('./features/instructor/materiales/existencias.component').then((m) => m.InstructorMaterialesExistenciasComponent) },
          ...
          { path: 'instructor/materiales/categorias', canActivate: [roleGuard], data: { roles: ['instructor'], serviciosRequeridos: ['materiales.categorias.ver'] }, loadComponent: () => import('./features/instructor/materiales/categorias.component').then((m) => m.InstructorMaterialesCategoriasComponent) },

          // ── Materiales (bodega) — aprendiz: solo lectura + solicitar/recibir préstamos propios. Mismo criterio que instructor arriba.
          { path: 'aprendiz/materiales/existencias', canActivate: [roleGuard], data: { roles: ['aprendiz'], serviciosRequeridos: ['materiales.existencias.ver'] }, loadComponent: () => import('./features/aprendiz/materiales/existencias.component').then((m) => m.AprendizMaterialesExistenciasComponent) },
